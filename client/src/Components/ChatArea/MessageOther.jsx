...
const MessageOther = ({ message }) => {
    return (
        <div className="bg-lightApp my-5 p-2.5 rounded-xl w-max md:max-w-[50%]">
            ...
            <div className="italic text-gray-500 flex flex-row-reverse">
                <p>
                    {`${moment(message.createdAt).format("DD/MM/YY")} ${moment(
                        message.createdAt
                    ).format("HH:mm")}`}
                </p>
            </div>
